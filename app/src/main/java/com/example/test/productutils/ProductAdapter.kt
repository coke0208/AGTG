...
class ProductAdapter(private val context: Context, private var productList: MutableList<ProductDB>, private val storageType: String) :
    RecyclerView.Adapter<ProductAdapter.ProductViewHolder>(), Filterable {
    private var filteredProductList: MutableList<ProductDB> = productList
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                filteredProductList = if (charString.isEmpty()) {
                    ...
                    val filteredList = ArrayList<ProductDB>()
                    for (item in productList) {
                        if (item.name?.toLowerCase()?.contains(charString) == true) {
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                filteredProductList = results?.values as ArrayList<ProductDB>
